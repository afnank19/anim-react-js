...
const Work = () => {
  ...
  const projectCopy = [
    ...
    "A student run blog site, performant, scalable, bug free.",
    "A cli tool for quickly writing project based todos, directly in your terminal. Written in Go using Charm_.",
  ];
      ...
      <div className="work-content">
        ...
        >
          <div className="work-data">
            <Project
              projectTitle="The Sapphire"
              projectCopy={projectCopy[5]}
              url="https://thesapphire.pages.dev"
            />
            <Project
              projectTitle="todocli"
              projectCopy={projectCopy[6]}
              url="https://github.com/afnank19/todocli"
            />
            <Project
              projectTitle="Banished"
              projectCopy={projectCopy[0]}
              url="https://afnank19.itch.io/banished"
            />
            <Project
              projectTitle="BrainFlow"
              projectCopy={projectCopy[1]}
              url="https://github.com/afnank19/pomodoro-electron"
            />
            <Project
              projectTitle="OwnAuth"
              projectCopy={projectCopy[2]}
              url="https://github.com/afnank19/glitch-server-nodejs"
            />
            <Project
              projectTitle="Qwitter"
              projectCopy={projectCopy[3]}
              url="https://github.com/afnank19/OwnAuth"
            />
